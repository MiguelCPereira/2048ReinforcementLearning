...
enum ImGuiTableFlags_
{
    ...
    ImGuiTableFlags_SizingStretchProp          = 3 << 13,  // Columns default to _WidthStretch with default m_ConnectionWeights proportional to each columns contents widths.
    ImGuiTableFlags_SizingStretchSame          = 4 << 13,  // Columns default to _WidthStretch with default m_ConnectionWeights all equal, unless overridden by TableSetupColumn().

...
void dae::Minigin::LoadDemo() const 
{
	...
	qBertGameObject->AddComponent(new GraphicsComponent("QBert P1 Spritesheet.png", 50, 250,
		150, 150, 34, 0, 17, 16));
	...
	qBertGameObject2->AddComponent(new GraphicsComponent("QBert P2 Spritesheet.png", 445, 250,
		150, 150, 51, 0, 17, 16));
